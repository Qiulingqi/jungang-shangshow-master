...
import com.shangshow.showlive.common.utils.DisplayUtil;
...
public class SwipeListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public SwipeListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRightViewWidth = DisplayUtil.px2dip(context, mRightViewWidth);
...
//        this.mRightViewWidth = mRightViewWidth;
        this.mRightViewWidth = DisplayUtil.dip2px(getContext(), mRightViewWidth);
    }
