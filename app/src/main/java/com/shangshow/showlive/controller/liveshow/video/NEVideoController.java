...
public class NEVideoController {
    ...
    private View.OnClickListener mMuteListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            removeTimeOut();
            if (!mute_flag) {
                mMuteButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_mute01);
                mPlayer.setMute(true);
                mute_flag = true;
            } else {
                mMuteButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_mute02);
    ...
    private View.OnClickListener mSetPlayerScaleListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (mIsFullScreen) {
                ...
                mSetPlayerScaleButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_scale01);
                mIsFullScreen = false;
                ...
                mSetPlayerScaleButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_scale02);
                mIsFullScreen = true;
...
//        }
    ...
    private void initControllerView(View v) {
        startPauseLayout = (LinearLayout) v.findViewById(com.shangshow.showlive.R.id.play_pause_layout); //播放暂停按钮
        mPauseButton = (ImageView) v.findViewById(com.shangshow.showlive.R.id.mediacontroller_play_pause);
        if (startPauseLayout != null) {
        	if (mPaused) {
                mPauseButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_pause);
                mPlayer.pause();
        	}
        ...
        mSetPlayerScaleButton = (ImageView) v.findViewById(com.shangshow.showlive.R.id.video_player_scale);  //画面显示模式按钮
        scaleLayout = (LinearLayout) v.findViewById(com.shangshow.showlive.R.id.scale_layout);
        if(scaleLayout != null) {
        ...
        snapShotLayout = (LinearLayout) v.findViewById(com.shangshow.showlive.R.id.snapShot_layout);
        if (snapShotLayout != null) {
            snapShotLayout.requestFocus();
            snapShotLayout.setOnClickListener(mSnapShotListener);
        }

        mMuteButton = (ImageView) v.findViewById(com.shangshow.showlive.R.id.video_player_mute);  //静音按钮
        muteLayout = (LinearLayout) v.findViewById(com.shangshow.showlive.R.id.mute_layout);
        if (muteLayout != null) {
    		if (mPlayer.isHardware() && mPlayer.isInBackground()) {
            	if (mute_flag) {
                    mMuteButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_mute01);
    ...
    private void updatePausePlay() {
        ...
        if (mPlayer.isPlaying()) {
            mPauseButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_play);
        }
        else {
            mPauseButton.setImageResource(com.shangshow.showlive.R.drawable.nemediacontroller_pause);
        }
