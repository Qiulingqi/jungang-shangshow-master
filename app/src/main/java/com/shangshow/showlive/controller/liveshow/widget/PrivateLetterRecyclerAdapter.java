 ...
 */
public class PrivateLetterRecyclerAdapter extends SuperAdapter<PrivateLetter> {
    private LiveWidgetOperate.LiveAudienceInterface liveAudienceInterface;
    public PrivateLetterRecyclerAdapter(Context context, LiveWidgetOperate.LiveAudienceInterface liveAudienceInterface, List<PrivateLetter> items, int layoutResId) {
        super(context, items, layoutResId);
        this.liveAudienceInterface=liveAudienceInterface;
    }

    public PrivateLetterRecyclerAdapter(Context context, LiveWidgetOperate.LiveAudienceInterface liveAudienceInterface, List<PrivateLetter> items, IMulItemViewType<PrivateLetter> mulItemViewType) {
    ...
    public void onBind(SuperViewHolder holder, int viewType, int layoutPosition, final PrivateLetter item) {
        ...
        replyMessageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               liveAudienceInterface.onClickReplyPrivateLetter(item.getUserInfo());
            }
        });
    }
