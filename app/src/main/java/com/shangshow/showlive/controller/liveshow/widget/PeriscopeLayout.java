...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(com.shangshow.showlive.R.drawable.pl_red);
        Drawable yellow = getResources().getDrawable(com.shangshow.showlive.R.drawable.pl_yellow);
        Drawable blue = getResources().getDrawable(com.shangshow.showlive.R.drawable.pl_blue);
    ...
    private PointF getPointF(int scale) {
        ...
        pointF.y = random.nextInt((mHeight + 250));
        return pointF;
    }
