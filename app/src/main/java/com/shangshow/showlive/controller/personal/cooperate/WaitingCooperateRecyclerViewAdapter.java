...
/**
 * 合作的时候     如果是自己发起的就取消   如果是别人发起的就设置为  同意或拒绝
 */

public class WaitingCooperateRecyclerViewAdapter extends QuickAdapter<UserInfo> {

    private int mRightWidth = 0;

    public WaitingCooperateRecyclerViewAdapter(int mRightWidth, Context context, int layoutResId, List<UserInfo> data) {
    ...
    protected void convert(BaseAdapterHelper helper, final UserInfo item, final int position) {
        ...
        TextView agreeText = helper.getView(R.id.agree_text_view);
