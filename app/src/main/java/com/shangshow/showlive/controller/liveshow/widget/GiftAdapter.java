...
public class GiftAdapter extends BaseAdapter {
    ...
    public void changeGiftData(List<Gift> gifts) {
        this.gifts = gifts;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(com.shangshow.showlive.R.layout.nim_gift_item, null);
            viewHolder = new ViewHolder();
            viewHolder.title = (TextView) convertView.findViewById(com.shangshow.showlive.R.id.title);
            viewHolder.image = (ImageView) convertView.findViewById(com.shangshow.showlive.R.id.image);
            viewHolder.count = (TextView) convertView.findViewById(com.shangshow.showlive.R.id.count);
