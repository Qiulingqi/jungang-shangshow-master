...
public class PrivateLetterRecyclerAdapter extends SuperAdapter<PrivateLetter> {
    public PrivateLetterRecyclerAdapter(Context context, List<PrivateLetter> items, int layoutResId) {
        super(context, items, layoutResId);
    }

    public PrivateLetterRecyclerAdapter(Context context, List<PrivateLetter> items, IMulItemViewType<PrivateLetter> mulItemViewType) {
