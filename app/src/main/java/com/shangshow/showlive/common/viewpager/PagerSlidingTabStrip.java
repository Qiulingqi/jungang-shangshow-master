...
package com.shangshow.showlive.common.viewpager;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private int checkedTextColor = R.color.skin_page_tab_underline_color;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        checkedTextColor = a.getResourceId(R.styleable.TwoTextView_ttLeftTextColor, R.color.white);
